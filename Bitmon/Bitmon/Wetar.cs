...
namespace Bitmon
{
    public class Wetar:Bitmon
    {
        public int maxTiempoVida = 10;
        public int minTiempoVida = 4;
        public int maxpuntosAtaque = 40;
        ...
        public Wetar()
        {
            ...
            enemigos.Add("Gofue", 1.5);
            enemigos.Add("Dorvalo", 1.0);
            terrenosafin.Add("Acuatico"); 

            bitmonsAfines = new List<string>();
            bitmonsAfines.Add("Taplan");
            bitmonsAfines.Add("Wetar");
