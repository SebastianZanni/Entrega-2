    ...
    class Simulador
    {
        ...
        public void mostrarEstadisticas()
        {
            ...
            else
            {
                ...
                tasaBrutaNatalidadDorval = (cantidadHijosDorval / contadorDorval) * 10;
            ...
            else
            {
                ...
                tasaBrutaNatalidadDoti = (cantidadHijosDoti / contadorDoti) * 10;
            ...
            else
            {
                ...
                tasaBrutaNatalidadEnt = (cantidadHijosEnt / contadorEnt) * 10;
            ...
            else
            {
                ...
                tasaBrutaNatalidadWetar = (cantidadHijosWetar / contadorWetar) * 10;
            }
            if (contadorGofue == 0)
            {
                ...
                tasaBrutaNatalidadGofue = (cantidadHijosGofue / contadorGofue) * 10;
            ...
            if (contadorTaplan == 0)
            {
                ...
                tasaBrutaNatalidadTaplan = (cantidadHijosTaplan / contadorTaplan) * 10;
            ...
            Console.WriteLine("****************************************");
            Console.WriteLine("Dorvalo: " + Math.Round(tasaBrutaNatalidadDorval, 2, MidpointRounding.AwayFromZero) + " hijos por cada 10 Dorvalo");
            Console.WriteLine("Doti: " + Math.Round(tasaBrutaNatalidadDoti, 2, MidpointRounding.AwayFromZero) + " hijos por cada 10 Doti");
            Console.WriteLine("Ent: " + Math.Round(tasaBrutaNatalidadEnt, 2, MidpointRounding.AwayFromZero) + " hijos por cada 10 Ent");
            Console.WriteLine("Gofue: " + Math.Round(tasaBrutaNatalidadGofue, 2, MidpointRounding.AwayFromZero) + " hijos por cada 10 Gofue");
            Console.WriteLine("Taplan: " + Math.Round(tasaBrutaNatalidadTaplan, 2, MidpointRounding.AwayFromZero) + " hijos por cada 10 Taplan");
            Console.WriteLine("Wetar: " + Math.Round(tasaBrutaNatalidadWetar, 2, MidpointRounding.AwayFromZero) + " hijos por cada 10 Wetar\n\n");

            Console.WriteLine("Tasa bruta de mortalidad. " + Math.Round(tasaBrutaMortalidad, 2, MidpointRounding.AwayFromZero) + " por cada " + (totalBitmonsVivos + totalBitmonsMuertos) + " Bitmons");
            Console.WriteLine("***************************************\n");
